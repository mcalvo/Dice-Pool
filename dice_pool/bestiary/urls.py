...
urlpatterns = patterns('bestiary.views',
   ...
   url(r'^(?P<mon_id>\d+)/edit$', 		                              'editMonster', 		                  name = "bestiary_editMonster"),
   url(r'^(?P<mon_id>\d+)/rebalance/$', 			                     'rebalanceMonster', 		               name = "bestiary_rebalanceMonster"),
   ...
   url(r'^(?P<mon_id>\d+)/attack/(?P<attack_id>\d+)/rebalance/$',    'rebalanceAttack',                     name = "bestiary_rebalanceAttack"),
)
