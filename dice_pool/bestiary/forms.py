...
class AttackForm(forms.ModelForm):
   ...
   def save(self, *args, **kwargs):
      ...
      if not self.instance.id:   
         ...
         record.averageDamage = bhelpers.averageDamage(record.monster.level,record.monster.minion,record.monster.role.heavyHitter,record.range,record.area,record.usage.limitedUsage,record.multiStrike,hasEffect)
